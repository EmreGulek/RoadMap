...
- **Harita API'si:** [Google Maps API](https://developers.google.com/maps) veya [OpenStreetMap API](https://openstreetmap.org)
- **Hava Durumu API'si:** [OpenWeatherMap API](https://openweathermap.org/api)
